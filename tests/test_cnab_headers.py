...
from cnab.cnab import CnabHeader
from cnab.types import Document


class TestCnabHeaders(TestCase):
    def setUp(self) -> None:
    ...
    def test_cnab_header_with_valid_data(self):
        ...
        personal_header = CnabHeader(customer_document=personal_doc, unique_id=1)
        company_header = CnabHeader(customer_document=company_doc, unique_id=2)
